...
int main() {
  /* ORIGINAL TEST with two different types of keys and values.
     Values only have one item. */
  LLRB_multimap<int, std::string> llrb1;
  std::vector<std::string> str_vector =
    { "Priscilla", "and", "Laura", "are", "really awesome" };
  ...
  std::cout << "Tree contains 'N'? "
            << std::boolalpha << llrb2.Contains('N') << std::endl;
  std::cout << "Tree contains 'M'? "
            << std::boolalpha << llrb2.Contains('M') << std::endl;
